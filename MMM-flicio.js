Module.register("MMM-flicio",{
  ...
  socketNotificationReceived: function(notification, payload) {
		...
		if (!this.config.allowQueued && payload.wasQueued && payload.queueTimeout > this.config.queueTimeout) {
			return
		}
      ...
      } else if (notification == "connectionStatusChanged" && button.connectionStatusChanged) {
				messages = {
